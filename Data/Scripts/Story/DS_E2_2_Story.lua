...
function Begin_GC(message)
	if message == OnEnter then
		...
		special_structures = {"C_GALACTIC_PERIMETER_OUTPOST", "C_BERTH", "C_GOLAN", "DS_SENSOR_RELAY", "DS_TRADE_PORT", "DS_HYDROPONICS", "DS_GALACTIC_CARGO", "DS_GALACTIC_HYPERLANES", "DS_ORBITAL_MANUFACTURING", "DS_GALACTIC_ASTEROID_MINE", "DS_GALACTIC_GAS_EXTRACTOR", "DS_GALACTIC_ORBITAL_DEFENCE_POD", "C_HANGAR"}
		...
		plot = Get_Story_Plot("DS_E2_2.xml") 
