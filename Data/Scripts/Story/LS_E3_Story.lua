...
function Begin_GC(message)
	if message == OnEnter then
		...
		special_structures = {"RA_GALACTIC_PERIMETER_OUTPOST", "RA_BERTH", "RA_GOLAN", "LS_SENSOR_RELAY", "LS_TRADE_PORT", "LS_HYDROPONICS", "LS_GALACTIC_CARGO", "LS_GALACTIC_HYPERLANES", "LS_ORBITAL_MANUFACTURING", "LS_GALACTIC_ASTEROID_MINE", "LS_GALACTIC_GAS_EXTRACTOR", "LS_GALACTIC_ORBITAL_DEFENCE_POD", "RA_HANGAR"}
