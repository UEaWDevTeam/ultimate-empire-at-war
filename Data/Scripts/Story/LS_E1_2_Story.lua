...
function Begin_GC(message)
	if message == OnEnter then
		...
		special_structures = {"OR_GALACTIC_PERIMETER_OUTPOST", "OR_BERTH", "OR_GOLAN", "LS_SENSOR_RELAY", "LS_TRADE_PORT", "LS_HYDROPONICS", "LS_GALACTIC_CARGO", "LS_GALACTIC_HYPERLANES", "LS_ORBITAL_MANUFACTURING", "LS_GALACTIC_ASTEROID_MINE", "LS_GALACTIC_GAS_EXTRACTOR", "LS_GALACTIC_ORBITAL_DEFENCE_POD", "OR_HANGAR"}
		...
		plot = Get_Story_Plot("LS_E1_2.xml") 
