...
function Begin_GC(message)
	if message == OnEnter then
		...
		special_structures = {"IR_BERTH", "IR_GOLAN", "DS_SENSOR_RELAY", "DS_TRADE_PORT", "DS_HYDROPONICS", "DS_GALACTIC_CARGO", "DS_GALACTIC_HYPERLANES", "DS_ORBITAL_MANUFACTURING", "DS_GALACTIC_ASTEROID_MINE", "DS_GALACTIC_GAS_EXTRACTOR", "DS_GALACTIC_ORBITAL_DEFENCE_POD", "IR_HANGAR"}
